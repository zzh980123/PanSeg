...
class TransForward(nn.Module):
    def __init__(self, in_channels=1, hidden_dim=16, out_channels=4, max_scaling=4):
        ...
        self.conv_span = nn.Conv2d(in_channels, hidden_dim // 2, kernel_size=1, padding=0)
        self.downSample1 = common.HugeDown(hidden_dim // 2, hidden_dim)
        self.downSample2 = common.HugeDown(hidden_dim, hidden_dim * 2)
        self.downSample3 = common.HugeDown(hidden_dim * 2, hidden_dim * 4)
        self.downSample4 = common.HugeDown(hidden_dim * 4, hidden_dim * 8)
        self.downSample5 = common.HugeDown(hidden_dim * 8, hidden_dim * 16)
        self.upSample0 = common.HugeUp(hidden_dim * 16, hidden_dim * 8, False)
        ...
        self.upSample4 = common.HugeUp(hidden_dim, out_channels, False)
...
class TransFlowNet(nn.Module):
    ...
    def forward(self, x, label):
        ...
        output = self.trans_back(feature, params)
        return trans_f, trans_f_label, feature, output, s_normal, xy_normal
